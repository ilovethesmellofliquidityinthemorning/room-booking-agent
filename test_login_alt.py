#!/usr/bin/env python3
"""
Test script for Momentus login functionality (Alternative port 9223)
"""
...
def test_login():
    ...
    print("Starting browser automation (connecting to Chrome on port 9223)...")
    
    # Create automation instance (connect to existing Chrome debug session on alt port)
    automation = MomentusAutomation(headless=False, use_existing_session=True, debug_port=9223)
